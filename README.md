...
| `…/mcp/onboardai-new-hire-welcome` | `onboard_new_hire` | employee_id, employee_name, email, isVirtual | email_status, calendar_status, overall_status |
...
- `policy_documents`, `policy_chunks` (pgvector, 768 dimensions): used by the Policy Intelligence MCP.
